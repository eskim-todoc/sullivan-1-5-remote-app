...
public class ActionMessage
{
    ...
    // 사용자 전환 관련
    public final static String NEW_FRAGMENT_USER = PREFIX + "NEW_FRAGMENT_USER";
    public final static String NEW_FRAGMENT_MANAGEMENT_USER = PREFIX + "NEW_FRAGMENT_MANAGEMENT_USER";
    public final static String NEW_FRAGMENT_MANAGEMENT_DEVICE = PREFIX + "NEW_FRAGMENT_MANAGEMENT_DEVICE";
    ...
    public String toString()
    {
        return "ActionMessage{" +
                ...
                ", NEW_FRAGMENT_MANAGEMENT_USER=" + NEW_FRAGMENT_MANAGEMENT_USER +
                '}';
    }
}
